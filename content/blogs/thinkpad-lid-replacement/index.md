...
![Removed display](img/display.jpg "*Display removed, resting on the keyboard.*")
...
![Antenna wires](img/case.jpg "*Antenna wires inside the chassis.*")
...
![Reattached camera](img/new-camera.jpg "*Camera module reattached using double-sided tape.*")

### Reattach the ribbon cable

![Cable reattached half way](img/ribbon-1.jpg "*Ribbon cable of the camera attached with tape (connect the cable to the module first).*")

![Cable attached fully](img/ribbon-2.jpg "*Ribbon cable of the LED attached.*")
...
![Display with tape](img/tape.jpg "*Display connected with tape ready for the bezel.*")

### Put on the bezel and admire your work

![Finished product](img/finished.jpg "*Bezel reattached and the work is done.*")
